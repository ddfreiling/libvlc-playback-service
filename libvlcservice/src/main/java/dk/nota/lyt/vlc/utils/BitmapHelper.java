...
public class BitmapHelper {
    private static final String TAG = BitmapHelper.class.getCanonicalName();
    ...
    public static Bitmap fetchAndRescaleBitmap(String uri, int width, int height)
        ...
        try {
            ...
            Log.d(TAG, String.format("Scaling bitmap %s by factor %d to support %dx requested dimension"));
            is.reset();
