...
public class MediaNotificationManager extends BroadcastReceiver {
    private static final String TAG = MediaNotificationManager.class.getCanonicalName();

    private static final int NOTIFICATION_ID = 412;
    private static final int REQUEST_CODE = 100;

    private static final String ACTION_PREFIX = "dk.nota.lyt.notification.";
    public static final String ACTION_PAUSE = ACTION_PREFIX + "pause";
    public static final String ACTION_PLAY = ACTION_PREFIX + "play";
    public static final String ACTION_PREV = ACTION_PREFIX + "prev";
    ...
    private Activity mOnClickActivity;
    private String mOnClickAction;
    ...
    public void setOnClickActivity(Activity onClickActivity, String action) {
    ...
    private PendingIntent createContentIntent(MediaDescriptionCompat description) {
        Intent onClickIntent = new Intent(mService, mOnClickActivity.getClass());
        onClickIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        onClickIntent.setAction(mOnClickAction);
        if (description != null) {
            //openUI.putExtra(MusicPlayerActivity.EXTRA_CURRENT_MEDIA_DESCRIPTION, description);
        }
        return PendingIntent.getActivity(mService, REQUEST_CODE, onClickIntent,
    ...
    private Notification createNotification() {
        ...
        if (mOnClickActivity != null) {
            notificationBuilder.setContentIntent(createContentIntent(description));
        }
    ...
    private void setNotificationPlaybackState(NotificationCompat.Builder builder) {
        ...
        boolean isPlaying1 = mService.isPlaying();
        boolean isPlaying2 = mPlaybackState.getState() == PlaybackStateCompat.STATE_PLAYING;
        Log.i(TAG, "=== SETTING ONGOING: "+ isPlaying2 + " ===");
        //builder.setOngoing(isPlaying2);
    }
